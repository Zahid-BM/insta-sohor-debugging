...
const addToLiked = (id) => {
  likedPostsId.push(id); /* bug fixed here */
  showPosts(posts);
};
              ...
              <div class="post__header">
                <div class="post__profile">
                  <a
                    ...
                    class="post__avatar"
                  >
                    <img src="${userImage /* bug fixed here */}" alt="User Picture" />
                  </a>
                  ...
                  <div class="post__description">
                    <small>
                      <a class="post__name--underline" href="#">
                          ${post?.comments[0]?.user /* bug fixed here */}
                      </a>
                      ${post?.comments[0]?.text/* bug fixed here */}
                    </small>
                  </div>
